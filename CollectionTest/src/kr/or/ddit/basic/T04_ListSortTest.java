...
public class T04_ListSortTest {
	...
	public static void main(String[] args) {
		...
		memList.add(new Member(2, "동길홍", "010-2222-2222"));
		memList.add(new Member(3, "길동홍", "010-3333-3333"));
		memList.add(new Member(4, "동홍길", "010-4444-4444"));
		memList.add(new Member(5, "길홍동", "010-5555-5555"));
