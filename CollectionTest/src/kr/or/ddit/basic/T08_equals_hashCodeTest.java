...
public class T08_equals_hashCodeTest {
	/*
	 * 해시 함수(hash function)은 임의의 데이터를 고정된 길이의 데이터로 매핑하는 함수이다.
	 * 해시 함수에 의해 얻어지는 값은 해시 값, 해시 코드, 해시 체크성 또는 간단하게 해시라고 한다.
	 ...
	 * 4. equals()메서드를 override하면 반드시 hascode()메서드도 override해야 한다.
