...
//			System.out.println("insert 작업 시작...");
			...
			mv.setMemId("a002");
			mv.setMemName("최영준sd");
			mv.setMemTel("0102634sd9926");
			mv.setMemAddr("서울광진구sd아아아");
			
			// 2) SqlMapClient객체 변수를 이용하여 해당 쿼리문을 실행
			//형식) smc.insert("namespace값.id값", 파라미터 객체) (id는 xml파일에서의 id이름)
			// 반환값 : 성공하면 null이 반환
...
//			mv2.setMemId("a002");
//			mv2.setMemName("김부산");
//			mv2.setMemTel("010-2342-2341");
//			mv2.setMemAddr("금정산성막걸리");
//			
//			
//			// udate()메서드의 반환값은 성공한 레코드 수 이다
...
//			int cnt = smc.delete("memberTest.deleteMember", "a002");
//			if(cnt > 0) {
