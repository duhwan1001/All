 ...
 * 한글 윈도우 메모장에서 말하는 ANSI 인코딩이란, CP949(Code Page 949)를 말한다.
 ...
 * 
 * ANSI는 영어를 표기하기 위해 만든 코드로 규격 자체에 한글이 없다가 나중에 여기에 EUC-KR,
 * CP949 이라는 식으로 한글이 포함되었음.
 * 
 * 참고)
 ...
 */
	public static void main(String[] args) {
		...
		try {
			...
			isr = new InputStreamReader(fis, "UTF-8"); // 인코딩 방식을 지정할수 있다.
