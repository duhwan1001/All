...
public class HorseRaceExam {
	...
	public static List<ansHorse> horseList = new ArrayList<ansHorse>(); // 말관리를 위한 리스트 변수 선언

	public static void main(String[] args) {

		horseList.add(new ansHorse("01번말"));
		horseList.add(new ansHorse("02번말"));
		horseList.add(new ansHorse("03번말"));
		horseList.add(new ansHorse("04번말"));
		horseList.add(new ansHorse("05번말"));
		horseList.add(new ansHorse("06번말"));
		horseList.add(new ansHorse("07번말"));
		horseList.add(new ansHorse("08번말"));
		horseList.add(new ansHorse("09번말"));
		horseList.add(new ansHorse("10번말"));
...
class ansHorse extends Thread implements Comparable<ansHorse> {
	 ...
	 */
	public ansHorse(String horseName) {
	...
	@Override
	public int compareTo(ansHorse o) {
	...
	public void run() {
		...
		while (true) {
			...
			for (int i = 0; i < HorseRaceExam.horseList.size(); i++) {
				...
				ansHorse horse = HorseRaceExam.horseList.get(i);
