...
public class T17_SimpleCollectionTest {
/**
...
//					list1.add(i); // 동기화 처리하지 않은것
		...
		System.out.println("동기화 처리하지 않은 list1의 개수 : " + list1.size());
		System.out.println("동기화 처리한 list2의 개수 : " + list2.size());
	}
}